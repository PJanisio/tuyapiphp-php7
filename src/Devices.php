...
class Devices
{
    ...
    [
        ...
        'get_functions' => '/v1.0/iot-03/devices/{device_id}/functions',
        'get_specifications' => '/v1.0/iot-03/devices/{device_id}/specifications',
        'get_status' => '/v1.0/iot-03/devices/{device_id}/status',
        ...
        'post_commands' => '/v1.0/iot-03/devices/{device_id}/commands',
